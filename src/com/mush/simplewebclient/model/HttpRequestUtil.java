package com.mush.simplewebclient.model;
...
public class HttpRequestUtil {
	 ...
	 * @throws Exception
	 */
	public  URLConnection sendGetRequest(String url,
	...
	public  URLConnection sendPostRequest(String url,
	 ...
	 *            上传文件
	 */
	public  boolean uploadFiles(String path, Map<String, String> params,
	 ...
	 * @throws Exception
	 */
	public  byte[] read2Byte(InputStream inStream) throws Exception {
	 ...
	 * @throws Exception
	 */
	public  String read2String(InputStream inStream) throws Exception {
		ByteArrayOutputStream outSteam = new ByteArrayOutputStream();
		byte[] buffer = new byte[1024];
		int len = 0;
		while ((len = inStream.read(buffer)) != -1) {
	 ...
	 * @throws Exception
	 */
	public  byte[] postXml(String path, String xml, String encoding)
			throws Exception {
