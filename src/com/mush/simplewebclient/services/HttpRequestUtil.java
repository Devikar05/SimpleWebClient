...
import com.mush.simplewebclient.SimpleWebClientAPP;
...
public class HttpRequestUtil {
		...
		if (params != null && !params.isEmpty()) {
			...
			for (Map.Entry<String, String> entry : entrys) {
				buf.append(entry.getKey()).append("=")
						.append(URLEncoder.encode(entry.getValue(), SimpleWebClientAPP.get_encode()))
						.append("&");
			}
	...
	public static String read2String(InputStream inStream)throws Exception{
		...
		outSteam.close();
		inStream.close();
		return new String(outSteam.toByteArray(),SimpleWebClientAPP.get_encode());
	}
	/**
	 * 发送xml数据
	 * @param path 请求地址
